...
class Update_DB:
    ...
    def scrap_df(self):
        from model_2.update_db.scraper import Scraper
    ...
    def filter_esg(self, df:pd.DataFrame, embeddings:np.ndarray=None)-> pd.DataFrame:
        ...
        '''
        from model_2.update_db.esg_filter.esg_filter import ESG_Filter
    ...
    def find_sentiment(self, df:pd.DataFrame)-> pd.DataFrame:
        ...
        '''
        from model_2.update_db.sentiment_analysis import Sent_model
